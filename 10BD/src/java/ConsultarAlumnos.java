...
public class ConsultarAlumnos extends HttpServlet {
    ...
    /**
     * Para poder establecer una conexion con bs
     * es necesario contar con 3 tipos de objetos muy especificos
     * los cuales son:
     * Connection es el encargado de establecer la conexion con el servidos BD
     * Statement sirve para poder definir y manipular 
     *                  los diferentes objetos de las querrys
     *                  como por ejemplo: create, delete, insert,
     *                  update, drop, etc
     * ResultSet el cual sirve para poder realizar las consultadas a la BD
     * 
     * 
     */
