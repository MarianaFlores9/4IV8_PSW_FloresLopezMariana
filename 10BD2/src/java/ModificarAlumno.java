    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if( rs.next()){
                       q = "Update alumnobatiz set nombre='"+nom+"',appat='"+appat+"',apmat='"+apmat+"',telefono='"+tel+"' where boleta="+boleta;
                ...
                out.println("<h1>Lo sentimos esta boleta no existe, no hay nada que actualizar, por favor verifica tus datos</h1>");
